...
CONFIG_SHA256 = "92b560a99fe213634e2ab51a17faf518a9add57b412c3a707b653d6c4fc77b4e"
PROFILE_ID = "oc2d.spike.model-candidate.source-preserve-v6.v1"
...
def _config() -> dict[str, object]:
    ...
    expected = {
        ...
        "postprocess": {
            "semantic_alpha_state": "source-preserve-v6-cleaned",
...
def _motion_lineage(motion: MotionRecomputation) -> list[dict[str, object]]:
    ...
    for layer in layers:
        ...
        operations = ["source-preserve-v6-alpha-clean", "subject-matte", "bbox-crop-padding-4"]
        if semantic == "face":
        ...
        generated_regions = [
            {
                ...
                "producer": "model-source-preserve-v6",
