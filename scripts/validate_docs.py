...
REQUIRED_FILES = (
    ...
    "docs/adr/0002-native-linux-model-runtime.md",
    "docs/gate-records/GATE_0.md",
    "docs/gate-records/GATE_F_TECHNICAL_PREREGISTRATION.md",
    ...
    "schemas/gate-f-run-spec/v0.1/run-spec.schema.json",
    "schemas/gate-f-acceptance-bundle/v0.1/report.schema.json",
    "schemas/gate-f-candidate-baseline/v0.1/config.schema.json",
    "schemas/gate-f-candidate-baseline/v0.1/report.schema.json",
    "schemas/gate-f-candidate-baseline/v0.2/config.schema.json",
    "schemas/gate-f-candidate-baseline/v0.2/report.schema.json",
    "schemas/gate-f-frame-sequence/v0.1/config.schema.json",
    "schemas/gate-f-layered-psd/v0.1/report.schema.json",
    "schemas/gate-f-model-motion-draft/v0.1/config.schema.json",
    "schemas/gate-f-model-motion-draft/v0.1/report.schema.json",
    "schemas/gate-f-model-motion-draft/v0.2/config.schema.json",
    "schemas/gate-f-model-motion-draft/v0.2/report.schema.json",
    "schemas/gate-f-model-motion-draft/v0.3/config.schema.json",
    "schemas/gate-f-model-motion-draft/v0.3/report.schema.json",
    "schemas/gate-f-model-candidate/v0.1/config.schema.json",
    "schemas/gate-f-model-candidate/v0.1/report.schema.json",
    "schemas/gate-f-model-candidate/v0.1/preflight-report.schema.json",
    "schemas/gate-f-model-candidate/v0.2/config.schema.json",
    "schemas/gate-f-model-candidate/v0.2/report.schema.json",
    "schemas/gate-f-model-candidate/v0.2/preflight-report.schema.json",
    "schemas/gate-f-model-candidate/v0.3/config.schema.json",
    "schemas/gate-f-model-candidate/v0.3/report.schema.json",
    "schemas/gate-f-model-candidate/v0.3/preflight-report.schema.json",
    "schemas/gate-f-paired-experiment/v0.1/report.schema.json",
    "schemas/gate-f-raster-normalization/v0.1/config.schema.json",
    "schemas/gate-f-raster-normalization/v0.1/report.schema.json",
    "schemas/gate-f-simple-cutout-comparator/v0.1/config.schema.json",
    "schemas/gate-f-simple-cutout-comparator/v0.1/report.schema.json",
    "schemas/gate-f-simple-cutout-comparator/v0.2/config.schema.json",
    "schemas/gate-f-simple-cutout-comparator/v0.2/report.schema.json",
    "schemas/gate-f-simple-cutout-comparator/v0.3/config.schema.json",
    "schemas/gate-f-simple-cutout-comparator/v0.3/report.schema.json",
    "schemas/run-manifest/v0.1/run-manifest.schema.json",
    "schemas/run-manifest/v0.2/run-manifest.schema.json",
    "schemas/validation-report/v0.2/validation-report.schema.json",
    "schemas/release/v0.1/dual-output-release.schema.json",
    "examples/gate-f-spike-smoke/README.md",
    "examples/gate-f-spike-smoke/run-spec.json",
    "examples/gate-f-spike-smoke/source.synthetic.json",
    "examples/gate-f-spike-smoke/configs/normalize.json",
    "examples/gate-f-spike-smoke/configs/proposal.json",
    "examples/gate-f-spike-smoke/configs/verify.json",
    "examples/gate-f-candidate-baseline/README.md",
    "examples/gate-f-technical-preflight/README.md",
    "examples/gate-f-candidate-baseline/config.json",
    "examples/gate-f-layered-psd/README.md",
    "examples/gate-f-model-motion-draft/README.md",
    "examples/gate-f-model-motion-draft/config.json",
    "examples/gate-f-model-candidate/README.md",
    "examples/gate-f-model-candidate/config.json",
    "examples/gate-f-paired-experiment/README.md",
    "examples/gate-f-raster-normalize/README.md",
    "examples/gate-f-simple-cutout-comparator/README.md",
    "examples/gate-f-simple-cutout-comparator/config.json",
    "spikes/gate_f_runner/acceptance.py",
    "spikes/gate_f_runner/candidate_baseline.py",
    "spikes/gate_f_runner/contracts.py",
    "spikes/gate_f_runner/frame_sequence.py",
    "spikes/gate_f_runner/gui_server.py",
    "spikes/gate_f_runner/gui/index.html",
    "spikes/gate_f_runner/gui/styles.css",
    "spikes/gate_f_runner/gui/app.js",
    "spikes/gate_f_runner/runtime.py",
    "spikes/gate_f_runner/runner.py",
    "spikes/gate_f_runner/local_preflight.py",
    "spikes/gate_f_runner/model_workbench.py",
    "spikes/gate_f_runner/model_motion_draft.py",
    "spikes/gate_f_runner/model_candidate.py",
    "spikes/gate_f_runner/paired_experiment.py",
    "spikes/gate_f_runner/psd_reader.py",
    "spikes/gate_f_runner/psd_writer.py",
    "spikes/gate_f_runner/raster.py",
    "spikes/gate_f_runner/rendering.py",
    "spikes/gate_f_runner/simple_cutout.py",
    "spikes/gate_f_runner/synthetic.py",
    "spikes/gate_f_runner/__main__.py",
    "spikes/gate_f_runner/requirements-pillow-12.1.0-win-py314.txt",
    "tests/test_gate_f_model_motion_draft.py",
    "tests/test_gate_f_model_candidate.py",
)
...
INDEX_LINK_TARGETS = (
    ...
    "gate-records/GATE_F_TECHNICAL_PREREGISTRATION.md",
