...
This v13 fixed configuration connects a previously validated local `source-preserve.v4` model run to deterministic semantic bounding-box quads, five affine research bindings, neutral-frame passthrough, and the shared 37-frame Gate F sequence.
