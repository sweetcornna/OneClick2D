...
This schema v0.2 / profile v14 fixed configuration connects a previously validated local `source-preserve.v5` model run to deterministic semantic bounding-box quads, five affine research bindings, neutral-frame passthrough, and the shared 37-frame Gate F sequence.
...
Run it only after the active v5 model workbench report passes neutral fidelity validation:
