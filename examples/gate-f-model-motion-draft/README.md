...
This schema v0.3 / profile v15 fixed configuration connects a previously validated local `source-preserve.v6` model run to deterministic semantic bounding-box quads, five affine research bindings, neutral-frame passthrough, and the shared 37-frame Gate F sequence.
...
Run it only after the active v6 model workbench report passes neutral fidelity validation:
